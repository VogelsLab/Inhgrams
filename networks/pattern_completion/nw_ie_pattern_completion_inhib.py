...
def single_run(seed=42, target_e=3, target_i=10, stim=28):
    ...
    br.device.reinit()
    br.device.activate()
    folder = f"./output/{seed}_{target_e}_{target_i}_{stim}_630sec"
...
#example call: python nw_iall_pattern_completion_stim.py --seed 42 --target_e 3 --target_i 10 --stim 28