...
def main_loop(seed=30001, target_e=3, target_i=10, overlap_exc=28, overlap_inh=28, folder='output'):
    ...
    SynP = br.Synapses(P, SE[:196], 'w : siemens', on_pre='gE += w')
    SynP.connect(p=0.05)
    SynP.w = 3*nS
...
#example call: python nw_iall_pattern_separation_stim.py --seed 42 --target_e 3 --target_i 10 --overlap_exc 20 --overlap_inh 20